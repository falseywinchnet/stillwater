...
int main(int argc, char** argv) {
    ...
    for (int index = 1; index < argc; ++index) {
        ...
        if (std::strcmp(argument, "--preview") == 0)
        ...
        else if (std::strcmp(argument, "--leaf-self-shadows") == 0)
            options.leaf_self_shadows = true;
            ...
            std::cout << "Stillwater [--desktop|--preview] [--muted] [--paused] [--fps 1..60]\n  "
                         ...
                         "[--record-shading] [--specialize-foliage|--generic-foliage] [--no-leaf-grain] [--leaf-self-shadows] [--compact-camera|--dense-camera] [--full-redraw] [--verify-retained directory] [--capture-time seconds]\n  "
