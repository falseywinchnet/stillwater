...
The original prototype evidence below was collected on Apple M4 / macOS 26.5
on 2026-09-23. Current MacBook Neo storage, image, query and sanitizer verification
is documented separately in [METAL_STORAGE.md](METAL_STORAGE.md). These are local
development builds.
